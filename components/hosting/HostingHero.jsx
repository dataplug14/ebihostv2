                    ...
                    >
                        <div className="vstack items-center gap-2 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
                            ...
                            <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                                From personal blogs to business websites, we have the perfect
                                hosting solution for you. Fast, secure, and backed by 24/7
                                expert support.
                            </p>
                            <div className="d-flex flex-column sm:flex-row items-center justify-center gap-2 mt-2">
                                <Link
                                    href="#products"
