...
export default function WordPressHostingHero() {
    return (
                    ...
                    >
                        <div className="vstack items-center gap-2 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-750px mx-auto text-center">
                            <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                                Built for WordPress. Ready for You.
                            </h1>
                            <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                                Launch your WordPress site fast with fully optimized hosting.
                                Simple setup, solid performance you can count on from
                                ₦2,098/month.
                            </p>
