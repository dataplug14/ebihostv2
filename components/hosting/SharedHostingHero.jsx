...
export default function SharedHostingHero() {
    return (
                    ...
                    >
                        <div className="vstack items-center gap-2 lg:gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-750px mx-auto text-center">
                            ...
                            <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                                Get your website online with us - free domain, 99.9% uptime,
                                unmetered bandwidth, free migration and 24/7 support for just
                                ₦1,499/month.
                            </p>
