        ...
        >
          <div className="container max-w-xl">
            ...
            >
              ...
              <div className="uc-navbar-center d-none lg:d-flex">
                <ul className="uc-navbar-nav gap-3 xl:gap-4 fw-medium">
                  <Nav />
                </ul>
              </div>
              <div className="uc-navbar-right">
                <div className="d-none lg:d-flex hstack gap-3 items-center">
                  <CurrencySelect />
                  <a
                    href="https://my.ebihost.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn btn-sm btn-primary text-white text-none"
                  >
                    My Account
                  </a>
                </div>
