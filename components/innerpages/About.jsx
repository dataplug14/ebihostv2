          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              ...
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                Founded in 2025, Ebihost was born from a vision to make premium
                web hosting accessible to everyone. We believe every business,
                from startups to enterprises, deserves fast, secure, and
                reliable hosting that grows with their needs. Today, Ebihost
                empowers thousands of businesses across Africa with world-class
                hosting powered by cutting-edge technology and backed by 24/7
                expert support.
              </p>
            </div>
