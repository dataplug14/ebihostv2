      ...
      <div className="section-outer panel py-6 xl:py-9 bg-secondary dark:bg-gray-800">
        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 mb-4">How Ebihost helps</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                Businesses use Ebihost to power their online presence with
                fast, secure, and reliable web hosting. From shared hosting for
                startups to cloud VPS for enterprises, we provide the
                infrastructure you need to succeed online. With NVMe storage,
                free SSL, and 24/7 expert support, your website is always in
                good hands.
              </p>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                Founded in 2025, Ebihost emerged from a simple mission: make
                premium hosting accessible to everyone in Africa and beyond. We
                combine world-class infrastructure with local expertise to
                deliver hosting solutions that help businesses grow. Today,
                we're trusted by thousands of customers who rely on us for
                their domains, hosting, and business email needs.
              </p>
