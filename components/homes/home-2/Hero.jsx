              ...
              <div className="col-12 sm:col-9 lg:col-5">
                ...
                >
                  ...
                  <h1 className="h2 sm:h1 lg:display-6 xl:display-5 mb-1 xl:mb-2">
                    The Web Hosting You Deserve.
                  </h1>
                  <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70">
                    Get your website online with us in no time — fast, secure,
                    and built to grow with your needs.
                  </p>
                  <form
                    action="https://my.ebihost.com/cart.php"
                    method="get"
                    target="_blank"
                  ...
                  <p className="fs-7 text-dark dark:text-white text-opacity-70">
                    Starting from ₦1,499/month • 30-day money-back guarantee
                  </p>
                </div>
              </div>
