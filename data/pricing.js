...
export const tiers3 = [
  {
    ...
    price: "₦7,000",
    yearlyPrice: "₦7,000",
    priceDetails: "per year • (1GB) Linux Shared Hosting",
    linkText: "Get Started",
    linkHref: "https://my.ebihost.com/index.php?rp=/store/cloud-web-hosting/solo",
    linkSubtext: "Host One Website",
    features: [
      "1GB SSD Storage",
      "10GB Bandwidth",
      "Free .name.ng Domain",
  ...
  },
  {
    ...
    price: "₦750",
    yearlyPrice: "₦750",
    priceDetails: "per month • (5GB) Linux Web Hosting",
    linkText: "Get Started",
  ...
  },
  {
    ...
    price: "₦1,250",
    yearlyPrice: "₦1,250",
    priceDetails: "per month • (10GB) Linux Web Hosting",
    linkText: "Get Started",
    linkHref: "https://my.ebihost.com/index.php?rp=/store/cloud-web-hosting/standard",
    linkSubtext: "30-day money-back guarantee",
    features: [
      "10GB SSD Storage",
  ...
  },
  {
    ...
    price: "₦1,550",
    yearlyPrice: "₦1,550",
    priceDetails: "per month • (15GB) Linux Web Hosting",
    linkText: "Get Started",
  ...
  },
  {
    ...
    price: "₦1,800",
    yearlyPrice: "₦1,800",
    priceDetails: "per month • (20GB) Linux Web Hosting",
    linkText: "Get Started",
  ...
  },
  {
    ...
    price: "₦2,300",
    yearlyPrice: "₦2,300",
    priceDetails: "per month • (25GB) Linux Web Hosting",
    linkText: "Get Started",
    linkHref: "https://my.ebihost.com/index.php?rp=/store/cloud-web-hosting/advanced",
    linkSubtext: "30-day money-back guarantee",
    features: [
      "25GB SSD Storage",
