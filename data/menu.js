export const menuItems = [
  ...
  },
  {
    ...
    subItems: [
      {
        href: "https://my.ebihost.com/cart.php?a=add&domain=register",
        label: "Register Domain",
        external: true,
      },
      {
        href: "https://my.ebihost.com/cart.php?a=add&domain=transfer",
        label: "Transfer Domain",
        external: true,
      },
      {
        href: "https://whois.ebihost.com",
        label: "WHOIS Lookup",
        external: true,
      },
    ],
  },
  {
    ...
    subItems: [
      {
        href: "https://my.ebihost.com/store/ssl-certificates",
        label: "SSL Certificates",
        external: true,
      },
      {
        href: "https://my.ebihost.com/store/sitelock",
        label: "Web Security",
        external: true,
      },
      {
        href: "https://my.ebihost.com/store/codeguard",
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        href: "https://my.ebihost.com/knowledgebase",
        label: "Knowledgebase",
        external: true,
      },
      {
        href: "https://status.ebihost.com",
...
export const icons = [
  { href: "https://facebook.com/ebihost", iconClass: "unicon-logo-facebook icon-2" },
  { href: "https://twitter.com/ebihost", iconClass: "unicon-logo-x-filled icon-2" },
  { href: "https://instagram.com/ebihost", iconClass: "unicon-logo-instagram icon-2" },
];
