...
export const metadata = {
  title:
    "About Ebihost || Premium Web Hosting & Domains for Everyone",
  description:
    "Learn about Ebihost - Founded in 2025, we provide fast, secure, and reliable web hosting solutions for businesses of all sizes.",
};
